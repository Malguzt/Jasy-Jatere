...
- Phase 5: in progress with perception ingest and control-plane-owned recording catalog APIs (`/api/perception/*`, `/api/recordings`), plus retirement of detector recording aliases (`/api/detector/recordings*` -> `410`).
