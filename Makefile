...
run-with-stream-gateway:
	STREAM_GATEWAY_API_URL=http://stream-gateway:4100 STREAM_RUNTIME_ENABLED=0 STREAM_WEBSOCKET_GATEWAY_ENABLED=0 docker compose --profile stream-gateway up -d
